...
3. Отображается фотография чата
4. Отображается название чата
5. Отображается тип чата
...
3. При вводе пустого названия чата, появляется ошибка "Название группы не может быть пустым"
   
   ![alt text](image-132.png)

4. При вводе названия чата больше 20 символов, появляется ошибка "Название группы не может быть длиннее 20 символов"
...
2. Клик по карточке файла начинает его загрузку
...
**В контейнере содержится интерфейс упраления личным чатом**
...
### 5. Информация о группе

![alt text](image-136.png)

#### 5.1. Контейнер "участники"
...
#### 5.2. Контейнер "участники и вложения"
...
#### 5.3. Контейнер "управление группой"
...
### 6. Информация о канале

![alt text](image-145.png)

#### 6.1. Контейнер "управление чатом"
**В контейнере содержится интерфейс упраления чатом**

1. Клик на кнопку "Выйти из группы" убирает группу из списка чатов и возвращает пользователя на главную страницу
...
1. Выбор файла `pdf` в качестве аватара - ошибка

    ![Alt text](image-21.png)

2. Выбор файла `zip` в качестве аватара - ошибка

    ![Alt text](image-29.png)

3. Выбор файла размером 1 Гб в качестве аватара - ошибка
...
1. Ввод 1000 года рождение в поле "дата рождения" - ошибка

    ![Alt text](image-30.png)

2. Ввод 2026 года  в поле "дата рождения" - ошибка

    ![Alt text](image-31.png)

3. Ввод 31 фераля в поле "дата рождения" - ошибка
...
4. Ввод набора символов `<>"{}()~*&^%$#@?!'_-+=:;.,/\|` в поле "описание профиля" - ошибок нет
    ...
    - Баг: некоректное отображение спецсимволов `<`, `>`, `"`, `&`, `'`
...
1. Ввод 3000 символ в поле "описание профиля" - ошибок нет

    ![Alt text](image-39.png)

2. Ввод 50000 символов в поле "описание профиля" - ошибок нет

    ![Alt text](image-40.png)

3. Ввод 500000 символов в поле "описание профиля" - ошибок нет, поле пустое

    ![Alt text](image-41.png)

    - Баг: нет ограничение на количество символов в поле "описание профиля", можно выставить 500000 символов, из-за чего при загрузке отображения поля сайт выдает ошибку 
...
3. При наведении на чат, он подсвечивается

    ![Alt text](image-67.png)

4. При нажатии на чат, открывается его содержимое; в списке чатов он подсвечивается
...
5. Чаты не отображаются, если совпадений нет
...
1. Ввод латинских символов - ошибок нет
2. Ввод кириллических символов - ошибок нет
3. Ввод цифр - ошибок нет
4. Ввод 20 символов - ошибок нет
...
1. При пустом вводе появляется ошибка
    ...
    - Баг: Выдается неконкретная ошибка о требовании к длине названия

2. Ввод набора символов <>"{}()~*&^%$#@?!'_-+=:;.,/\| - ошибка

    ![Alt text](image-78.png)

    - Баг: Выдается неконкретная ошибка о допустимых символах

3. Ввод смайликов Unicode - ошибка
    
    ![Alt text](image-79.png)

4. Ввод 21 символа - ошибка

    ![Alt text](image-81.png)

    - Баг: Выдается неконкретная ошибка о лимите в 20 символов в названии

###### 2.3.2.3 Чекбоксы с контактами

###### Позитивные кейсы

1. Создание чата с одним выбранным пользователем - ошибок нет

    ![Alt text](image-83.png)

2. Создание чата со всеми доступными пользователями (4) - ошибок нет
...
2. Если у пользователя нет контактов, он не может создать группу, т.к. он не может выбрать участников
