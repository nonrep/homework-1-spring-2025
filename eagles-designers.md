...
**В контейнере содержится информация информация о количестве участников в группе и кнопка добавления новых участников**
...
**В контейнере содержится интерфейс упраления группой**
...
6. Ввод 100000 слов в поле "описание профиля" - ошибок нет, поле пустое
    ...
    - Баг: нет ограничение на количество символов в поле "описание профиля", можно выставить 100000 слов, из-за чего при загрузке отображения поля сайт выдает ошибку 
